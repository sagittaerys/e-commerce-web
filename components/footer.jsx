...
export default function Footer() {
  ...
  return (
    <div className="container">
      <div className="pt-[50px] border-b-[#91929D] justify-between px-10 pb-[50px] flex bg-[#F4F4F5]">
        <div className="w-[30%]">
          <Link href="/">
        ...
        <div className="w-[30%] h-[12rem] bg-[#91929D] p-3 rounded-xl">
      ...
      <div className="payment px-10 py-6 flex items-center justify-between ">
        ...
        <div className="flex gap-3 items-center">
          <p className="text-[#23263B] font-bold">We Accept:</p>
